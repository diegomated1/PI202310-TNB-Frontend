...
export default function CardDetails() {
    return (
        <div className="flex flex-col w-screen h-screen">
            <AdminCardsNavBar />
            <div className="flex-1 w-full borderborder-gray-500 bg-gray-100 flex flex-col justify-center items-center p-5">
                    ...
                    <div className="col-span-3 p-5">
                        <div className="border border-gray-500 bg-white flex flex-col rounded-lg">
                            ...
                            <div className="p-5 w-full flex">
                                ...
                                <div className="flex-1 p-1">
                                    <div className="border border-gray-500 rounded-lg w-full h-full flex justify-center items-center">
                                        <span>0</span>
                                    </div>
                                </div>
                                <div className="flex-1 p-1">
                ...
                <div className="w-[80%] h-full grid grid-cols-2 lg:grid-cols-5">
                    ...
                    <div className="col-span-3 p-5">
                        <div className="w-full h-full border border-gray-500 bg-white rounded-lg"></div>
                    </div>
                </div>
            </div>
        </div>
