        ...
        <div className="w-screen h-screen bg-red-200 flex flex-col">
            ...
            <div className="flex-1 flex p-5">
                ...
                <div className="flex-[2] flex flex-col bg-green-200">
                    <div className="flex h-40 bg-blue-100">
                    ...
                    <div className="flex h-20 justify-center items-center">
                        <div className="flex-1 flex flex-col justify-center items-center">
                            ...
                            <div className="flex-1">
                                <span className="text-lg">Dueño: {user?.username}</span>
                            </div>
                        </div>
                        <div className="flex-1 flex flex-col justify-center items-center">
                            <div className="flex-1">
                                <span className="text-lg">Duracion de la subasta</span>
                            </div>
                            <div className="flex-1">
                        ...
                        <div className="flex-1 flex flex-col justify-center items-center">
                            <div className="flex-1">
                                <span className="text-lg">Inversion</span>
                            </div>
                            <div className="flex-1">
