...
const Icons:IIcon = {
    ...
    "profile": ({onClick, onmouseout, onmouseover, clickeable})=>(
        <svg onClick={onClick} onMouseOver={onmouseover} onMouseOut={onmouseout}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 stroke-while ${!!clickeable ? 'cursor-pointer' : ''}`}>
    ...
    "currency": ({onClick, onmouseout, onmouseover})=>(
        <svg onClick={onClick} onMouseOver={onmouseover} onMouseOut={onmouseout} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 stroke-white">
